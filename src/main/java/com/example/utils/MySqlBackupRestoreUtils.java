...
public class MySqlBackupRestoreUtils {
    ...
    public static boolean backup(String host, String userName, String password, String backupFolderPath, String fileName,
        ...
        File dir = new File("D:\\mysql-5.7.31-winx64\\bin");//此处是指定路径
        ...
        stringBuilder.append(" " + database).append(" > ").append(backupFilePath);
        try {
            // 调用外部执行 exe 文件的 Java API
            Process process = Runtime.getRuntime().exec(getCommand(stringBuilder.toString()), null, dir);
